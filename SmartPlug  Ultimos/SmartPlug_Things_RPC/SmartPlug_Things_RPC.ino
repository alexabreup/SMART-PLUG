...
const int THINGSBOARD_DELAY = 900000; // A cada 15 Minutos enviar dados para o ThingsBoard
...
void loop() {
  ...
  if (timeinfo->tm_hour == hora && (timeinfo->tm_min >= minuto && timeinfo->tm_min <= (minuto + 2)) || routerReset == true) {
    char timeString[6];
